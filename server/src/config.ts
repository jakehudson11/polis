...
export default {
  ...
  // Meeting/Integration services configuration
  recallWebhookSecret: process.env.RECALL_WEBHOOK_SECRET || null,
  perplexityApiKey: process.env.PERPLEXITY_API_KEY || null,
  recallApiKey: process.env.RECALL_API_KEY || null,
  recallApiBaseUrl: process.env.RECALL_API_BASE_URL || null,
  teamsClientId: process.env.TEAMS_CLIENT_ID || null,
  teamsClientSecret: process.env.TEAMS_CLIENT_SECRET || null,
  teamsTenantId: process.env.TEAMS_TENANT_ID || null,
  teamsRedirectUri: process.env.TEAMS_REDIRECT_URI || null,
  meetingOAuthEncryptionKey: process.env.MEETING_OAUTH_ENCRYPTION_KEY || null,
